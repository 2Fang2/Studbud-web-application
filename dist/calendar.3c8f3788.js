...
function createCalendarQuery(date) {
  ...
  arrayTwo.forEach(function (item, index) {
    ...
    item.forEach(function (itemData, itemIndex) {
      ...
      span3.classList.add("item-status");
      span3.innerHTML = "".concat(name, " ").concat(monthText(startDate), " ").concat(startDate.split("-")[2]);
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/calendar.js"], null)
