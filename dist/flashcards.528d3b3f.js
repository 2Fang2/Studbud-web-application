...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/flashcards.js":[function(require,module,exports) {
// get page dom
...
function createFlashcards() {
  var flashcardsInfo = JSON.parse(localStorage.getItem("flashcardsInfo"));
  flashcardsList.innerHTML = "";

  if (flashcardsInfo && flashcardsInfo.length > 0) {
    flashcardsInfo.forEach(function (v, i) {
      var question = v.question,
          answer = v.answer;
      var flashcardsItem = document.createElement("div");
      flashcardsItem.classList.add("flashcards-item");
      var flashcardsItemHead = document.createElement("div");
      flashcardsItemHead.classList.add("flashcards-item-head");

      var _p1 = document.createElement("p");

      _p1.innerHTML = "Question: ".concat(question);

      var _p2 = document.createElement("p");

      _p2.innerHTML = "Answer: ".concat(answer);
...
function showAnswer() {
  var flashcardsItem = document.querySelectorAll(".flashcards-item");
  flashcardsItem.forEach(function (v, i) {
    v.onclick = function () {
...
save.addEventListener("click", function () {
  ...
  createFlashcards(); // reset question answer infomation
...
deleted.addEventListener("click", function () {
  ...
  if (flashcardsInfo) {
    var val = confirm("Delete all questions and answers?");
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/flashcards.js"], null)
//# sourceMappingURL=/flashcards.528d3b3f.js.map